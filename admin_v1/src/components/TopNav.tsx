...
import { MessageSquare, Package, ShoppingCart, Users, Mail, Sun, Moon, Star, Gift, BadgePlus } from 'lucide-react';
...
export function TopNav({ isDark, onToggleTheme }: TopNavProps) {
  ...
  const getActiveSection = () => {
    ...
    if (location.pathname.startsWith('/gift-sets')) return 'gift-sets';
